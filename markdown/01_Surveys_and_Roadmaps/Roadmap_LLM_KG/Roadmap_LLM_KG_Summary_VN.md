...
**Tên bài báo:** Unifying Large Language Models and Knowledge Graphs: A Roadmap
**Tác giả:** Shirui Pan, Linhao Luo, Yufei Wang, Chen Chen, Jiapu Wang, Xindong Wu
**Nơi công bố/Năm:** IEEE Transactions on Knowledge and Data Engineering (TKDE), 2024 (Bản thảo 2023)
**Lĩnh vực:** Sự hội tụ giữa Large Language Models (LLM) và Knowledge Graphs (Đồ thị Tri thức - KG)

---

## 1. Bối cảnh: Hai trường phái trí tuệ nhân tạo (The Context)
